...
<div class="mt-2 p-3 rounded-xl space-y-2 bg-indigo-500/[0.08] border border-indigo-500/20">
	{#if data.title}
		<div class="flex items-center gap-1.5">
			<Icon icon="mdi:information-outline" width={13} class="text-indigo-400" />
			<p class="text-[11px] font-semibold text-indigo-300">{data.title}</p>
		</div>
	{/if}
